...
@Component({
  selector: "app-monthly-section-b",
  templateUrl: "./monthly-section-b.component.html",
  styleUrls: ["./monthly-section-b.component.scss"],
})
export class MonthlySectionBComponent implements OnInit {
  alert: any = {};
  ...
  submitFormB() {
    const promise = new Promise((resolve, reject) => {
      ...
      this._companyProfileService.addStagingSectionB(finalObj).subscribe(
        (response) => {
          return resolve({ data: finalObj, formName: "Section B" });
        },
        (err) => {
          console.log(err);
